...
1.1. Тест-сьют: функциональность кнопок "Купить", "Купить в кредит" на главной странице приложения (предусловие для всех тест-кейсов из данного тест-сьюта: приложение [aqa-shop.jar](https://github.com/Oksana-Zett/DIPLOMA2/blob/master/artifacts/aqa-shop.jar) запущено)

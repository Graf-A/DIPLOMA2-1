...
1.1. Тест-сьют: функциональность кнопок "Купить", "Купить в кредит" на главной странице приложения (предусловие для всех тест-кейсов из данного тест-сьюта: приложение [aqa-shop.jar](https://github.com/Graf-A/DIPLOMA3/blob/master/artifacts/aqa-shop.jar) запущено)
...
а) приложение [aqa-shop.jar](https://github.com/Graf-A/DIPLOMA3/blob/master/artifacts/aqa-shop.jar) запущено;  

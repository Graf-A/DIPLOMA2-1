...
public class CreditPaymentTest {
    ...
    void shouldPayByCardValid() {
        ...
        var Pay = PayByCard.PaymentByCredit();//открываем страницу оплаты
        ...
        String actualStatusCard1 = DBInteractions.creditPaymentRequest();// получаем статус из БД
        ...
        var actualStatusCard2 = DBInteractions.creditPaymentRequest();// получаем статус из БД
    ...
    void shouldOneFieldEmpty() {
        ...
        Assertions.assertEquals("Неверный формат", Pay.getTextCvcField());
        String actualStatus = DBInteractions.creditPaymentRequest();// получаем статус из БД
    ...
    void shouldCardNumberSeventeenNumeric() {
        ...
        Assertions.assertEquals(Data.readData(0, "status"), DBInteractions.creditPaymentRequest());// получаем статус из БД
    }
